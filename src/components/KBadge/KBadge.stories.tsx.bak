...
// } as Meta<typeof KBadge>

// More on component templates: https://storybook.js.org/docs/vue/writing-stories/introduction#using-args
const Template: StoryFn<typeof KBadge> = (args) => ({
...
export const Primary: StoryFn<typeof KBadge> = Template.bind({})
...
const appearanceTemplate: React.VFC<{}> = () => {
  return (
    <div>
...
export const Appearance: StoryFn<typeof KBadge> = (args) => ({
  components: { KBadge },
  setup() {
    return { args }
  },
...
export const Shape: StoryFn<typeof KBadge> = (args) => ({
  components: { KBadge },
  setup() {
    return { args }
  },
...
export const Colors: StoryFn<typeof KBadge> = (args) => ({
  components: { KBadge },
  setup() {
    return { args }
  },
...
export const DefaultSlot: StoryFn<typeof KBadge> = (args) => ({
  components: { KBadge },
  setup() {
    return { args }
  },
...
export const Theming: StoryFn<typeof KBadge> = (args) => ({
  components: { KBadge },
  setup() {
    return { args }
  },
